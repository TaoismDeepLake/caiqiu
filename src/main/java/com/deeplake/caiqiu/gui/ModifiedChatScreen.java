package com.deeplake.caiqiu.gui;
...
@OnlyIn(Dist.CLIENT)
public class ModifiedChatScreen extends Screen{

    private String historyBuffer = "";
    private int historyPos = -1;
    protected TextFieldWidget input;
    private String initial = "";
    public CommandSuggestionHelper commandSuggestions;

    public ModifiedChatScreen(String p_i1024_1_) {
    ...
    protected void init() {
        ...
        this.input = new TextFieldWidget(this.font, 4, this.height - 12, this.width - 4, 12, new TranslationTextComponent("chat.editBox")) {
            protected IFormattableTextComponent createNarrationMessage() {
                return super.createNarrationMessage().append(ModifiedChatScreen.this.commandSuggestions.getNarrationMessage());
            }
        };
