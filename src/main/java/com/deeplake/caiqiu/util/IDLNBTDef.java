...
public class IDLNBTDef {
   ...
   // public static final String INIT_DONE = "inited";
	...
	//prefix
	public static final String MSG_PREFIX = IdlFramework.MOD_ID + ".msg.";
    ...
    public static final String DEAL_DESC = "caiqiu.desc.deal";

    public static final String DESC_EGO_BASE = "caiqiu.desc.ego.";
	public static final String HP_DESC = "caiqiu.desc.ego.hp";
}
